...
// Function to find minimum element in the queue
int findMin(struct LQueue* queue) {
    if (isEmpty(queue)) {
        printf("Queue is empty! No minimum value.\n");
        return INT_MAX; // or another sentinel value
    }
...
// Function to find maximum element in the queue
int findMax(struct LQueue* queue) {
    if (isEmpty(queue)) {
        printf("Queue is empty! No maximum value.\n");
        return INT_MIN; // or another sentinel value
    }
